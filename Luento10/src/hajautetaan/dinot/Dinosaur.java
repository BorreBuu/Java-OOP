...
public class Dinosaur {
	...
	public static void main(String[] args) {
		...
		Dinosaur marjukka2 = new Dinosaur("Marjukka", 84, "Kentrosaurus", "Land", "mustikan varvut");
		...
		dinosaursHash.addDinosaur(4, marjukka2);
		
		System.out.println("From DinsaurHashMap object");
		...
		System.out.println(dinosaursHash.searchDinoWithName("Marjukka"));
	}
}
